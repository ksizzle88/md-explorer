/**
 * Drag-and-drop block reordering with Notion-style drag handle.
 * Kept from our implementation (battle-tested for VS Code webview).
 */
...
export default function DraggableBlockPlugin(): null {
  ...
  const getEditorRoot = useCallback(
    (): HTMLElement | null => editor.getRootElement(),
    [editor]
  );
