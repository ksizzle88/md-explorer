...
// Stub collab commands for VS Code
import {createCommand} from 'lexical';
const CONNECTED_COMMAND = createCommand<boolean>('CONNECTED_COMMAND');
const TOGGLE_CONNECT_COMMAND = createCommand<boolean>('TOGGLE_CONNECT_COMMAND');
import {
  $createTextNode,
  $getRoot,
  $isParagraphNode,
