...
// Shiki stubbed out for VS Code build (saves ~17MB)
const getCodeLanguageOptionsShiki = () => [] as Array<[string, string]>;
const getCodeThemeOptionsShiki = () => [] as Array<[string, string]>;
