  ...
  return (
    <>
      ...
      <div
        ...
        />
        {/* VS Code integration plugins injected from editor.tsx */}
        {(window as any).__vsCodePlugins && React.createElement((window as any).__vsCodePlugins)}
      </div>
...
function CollabV2({
  ...
  // Collaboration not supported in VS Code
  return null;
}
